  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "AutoPraxys — AI Capability Intelligence" },
      {
        ...
        content:
          "The intelligence layer for human-AI collaboration. Measure how humans grow with AI, not just what they produce.",
      },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "AutoPraxys" },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          "@type": "Organization",
          name: "AutoPraxys Private Limited",
          description:
            "Building Praxys, the world's first AI Capability Intelligence Platform.",
          brand: "Praxys",
        }),
      },
    ],
